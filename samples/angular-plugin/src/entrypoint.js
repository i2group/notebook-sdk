...
/**
 * Finds the first geospatial property value in a set of records
 *
...
async function main() {
  const api = await notebook.getEntryPointApi("3c789949-1955-4d4e-93fe-b5718effc325", "1.1");
  api.logger.info("plug-in running");

  const viewOnMap = api.commands.createCommand({
    id: "afedcac3-d45c-449f-95a6-5ec6f017c183",
    name: "View on map",
    icon: {
      type: "inlineSvg",
  ...
  const toggle = api.commands.createToolViewToggleCommand(
    {
      id: "4c54e911-0cf2-4e9e-96f4-720d43e77e71",
